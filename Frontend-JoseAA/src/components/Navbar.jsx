        ...
        <Link to="/" className="flex items-center gap-3">
          <div
            className={`bg-white transition-all duration-300 shadow-md flex items-center justify-center overflow-hidden
              ${
                isScrolled
                  ? "w-10 h-10 p-0.5 rounded-b-xl rounded-t-sm" // Scrolled state
                  : "w-16 h-16 p-0.5 rounded-b-2xl rounded-t-md" // Top state: Changed to p-0.5 (2px) for tight fit
              }`}
          >
            <img
              src={logoUrl}
      ...
      {isMobileMenuOpen && (
        ...
        >
          <div className="flex flex-col p-6 space-y-4 text-white text-center">
            ...
            <Link to="/blog" className="py-2 bg-blue-800 rounded">
              BLOG
            </Link>
