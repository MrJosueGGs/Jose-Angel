import { Facebook } from 'lucide-react'; // or your specific icon library
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="flex items-center gap-4">
            <div className="bg-white p-2 rounded-lg shadow-md h-16 w-16 flex items-center justify-center">
              <img src="https://i.imgur.com/1tbjjyM.png" alt="Escudo" className="w-full h-auto object-contain" />
            </div>
          ...
          <div className="flex gap-6">
            <a href="https://www.facebook.com/groups/11153488515/" target="_blank" rel="noopener noreferrer" className="text-white hover:text-red-500 transition transform hover:scale-110">
              <Facebook size={24} />
            </a>
          </div>
        </div>
